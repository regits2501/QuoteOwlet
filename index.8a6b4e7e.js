...
(function(modules, entry, mainEntry, parcelRequireName, globalName) {
    ...
    "hwUlY": [
        function(require, module1, exports1, __globalThis) {
            ...
            module1.bundle.HMR_BUNDLE_ID = "c26ef22bf71e6048";
            "use strict";
...
${frame.code}`;
   ...
   */ quoter.url = "https://quote-owlet-twiz-server-1.onrender.com/proxy/fetch/https://zenquotes.io/api/random"; // server url
                ...
                chromeCssBugFix.checkChromeMob = function() {
                    ...
                    this.chrome = /Chrome/g.test(browser1);
                    this.mobile = /Mobi/g.test(browser1);
                };
                        ...
                        Redirect.prototype.SPA = function(resolve, url) {
                            ...
                            if (resolve) {
                                ...
                                Promise.resolve().then(function() {
                                    return __parcel__require__(asset.url + '?t=' + Date.now());
                                }).then(function(res) {
                ...
                8: [
                    function(require, module1, exports1) {
                        ...
                        (function() {
                            ...
                            else if (typeof module1 === 'object' && module1 !== 'null') module1.exports = twiz;
                        })();
                    },
                    {
    ...
    "hwUlY",
    "8VGZO"
], "8VGZO", "parcelRequire94c2");

//# sourceMappingURL=index.8a6b4e7e.js.map
