   ...
   */
   ...
   function oauth() {
      ...
      var options = {
         ...
         "server_url":  'https://four-bushes-make.loca.lt', //'http://localhost:5000', // 'https://quoteowlet.herokuapp.com' 'https://quote-owlet-twiz-server-1.onrender.com'
   ...
   whenPageReady(function () { // when testing SPA case
      ...
      var options = {
         server_url: 'https://four-bushes-make.loca.lt',//'http://localhost:5000', //'https://quoteowlet.herokuapp.com',
         options: {
            method: "POST",
